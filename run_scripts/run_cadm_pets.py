...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_name', default='CaDM/', help="experiments name")
    ...
    parser.add_argument('--state_diff', type=int, default=1, help='flag to use state difference for history')
    parser.add_argument('--back_coeff', type=float, default=0.5, help='coefficient for backward loss')
    parser.add_argument('--history_length', type=int, default=10, help='length of history')
    parser.add_argument('--future_length', type=int, default=10, help='length of future timesteps')
